# INTG
Intg (INTerpolate Geoid) is used to interpolate the geoid height for a user specified position and geoid model. Estimates within gridded data models use spline or bilinear interpolation.
